      ...
      <section className="   sm:py-16 lg:py-24 ">
        ...
        <div className="space-y-16 container xl:max-w-7xl mx-auto px-4  py-16 lg:px-8 lg:py-32 ">
          ...
          <p className="leading-relaxed text-gray-600">
            ...
            technologies, including MERN stack ,Svelte, Python, React Native . I
            am always looking to learn new technologies and stay up-to-date with
            the latest trends in the field. Whether you are looking to create a
            new website, redesign an existing one, or add new features and
            functionality to your site, I am here to help. I would love the
            opportunity to discuss your project and see how I can assist you in
            achieving your online goals. Please feel free to contact me to learn
            more about my services and to discuss your project in more detail. I
        ...
        <div className=" p-2 flex gap-4 rounded-lg justify-center items-center">
          {Socials.map((item, i) => (
            <a href={item.link} target="_blank" key={i} rel="noreferrer">
              <img src={item.icon.src} className="h-8 w-8" alt={item.name} />
            </a>
          ))}
        </div>
      </div>
